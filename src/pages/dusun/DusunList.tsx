  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Link
          to="/dusun/new"
          className="inline-flex items-center justify-center rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
        >
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-300 pl-10 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 focus:outline-none"
            value={searchTerm}
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      <div className="flex items-center">
                        <div className="h-10 w-10 flex-shrink-0 rounded-full bg-green-100 flex items-center justify-center text-green-700 font-bold text-lg">
