  ...
  return (
    <div>
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <Link
          to="/events/new"
          className="mt-4 md:mt-0 inline-flex items-center rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700"
        >
      ...
      {filteredEvents.length > 0 ? (
        ...
        <div className="rounded-lg bg-white p-8 text-center shadow-md">
          <Calendar size={48} className="mx-auto mb-4 text-green-300" />
