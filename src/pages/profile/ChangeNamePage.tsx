...
export default function ChangeNamePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* 1. Header Banner */}
      <div className="relative h-48 bg-gradient-to-r from-green-700 via-green-600 to-green-800">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 bg-green-50 rounded-full flex items-center justify-center text-green-600 shadow-sm border border-green-100">
                <User size={32} />
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-100 focus:border-green-500 transition-all outline-none text-gray-900 bg-gray-50/50 focus:bg-white"
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full sm:flex-1 flex justify-center items-center gap-2 px-6 py-3 border border-transparent rounded-xl shadow-lg shadow-green-500/30 text-sm font-bold text-white bg-gradient-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-70 disabled:cursor-not-allowed transition-all transform hover:-translate-y-0.5"
                >
                  {isLoading ? (
                    <>
