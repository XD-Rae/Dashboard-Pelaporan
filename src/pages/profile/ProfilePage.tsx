            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden h-full flex flex-col">
              <div className="p-6 flex flex-col items-center text-center flex-1">
                ...
                <div className="w-32 h-32 rounded-full bg-white p-1.5 shadow-lg mt-10 mb-4 relative z-10">
                  <div className="w-full h-full rounded-full bg-green-600 flex items-center justify-center text-5xl font-bold text-white shadow-inner">
                    {avatarChar}
                  </div>
                </div>
                ...
                <div className="w-full space-y-3 mt-auto">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-sm shadow-sm"
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                {/* Role */}
                <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:border-green-300 transition-colors">
                  ...
                  <span className="inline-flex items-center px-3 py-1 rounded-md text-sm font-bold bg-green-50 text-green-700">
