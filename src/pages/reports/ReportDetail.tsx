        ...
        <div className="p-6 space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <a
                href={`https://wa.me/${formatWhatsappNumber(report.phone)}`}
                target="_blank"
            ...
            <div className="p-6 overflow-y-auto">
              {isKDUS ? (
                ...
                <form id="adminForm" onSubmit={handleSubmitTindakLanjut}>
                  ...
                  <textarea
                    rows={5}
                    className="w-full rounded-md border border-gray-300 p-3 focus:ring-2 focus:ring-green-500 outline-none"
