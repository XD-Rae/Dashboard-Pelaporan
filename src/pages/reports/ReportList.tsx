      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        {user?.role !== "KDUS" && (
          <div className="relative">
            ...
            />
            <select
              className="w-full rounded-md border border-gray-300 pl-10 py-2 text-sm focus:border-green-500 focus:ring-1 focus:ring-green-500 appearance-none bg-white cursor-pointer"
              value={selectedDusun}
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <div className="flex justify-end gap-2 border-t pt-3 border-gray-100">
                  <Link
                    ...
                    className="flex-1 inline-flex justify-center items-center rounded-md bg-green-50 px-3 py-1.5 text-sm font-medium text-green-700 hover:bg-green-100 transition-colors"
                  >
